    ...
    <form id="form1" runat="server">
            ...
            <table style="width:100%">
                <tr>
                    <td style="text-align:justify">
                        ...
                        <p>Ya estás Registrado al Sistema de Pedidos Online BAUBYTE</p>
                        <p></p>
                        <p>Nos alegra mucho que estés con nosotros . El Equipo BAUBYTE</p>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:center">
        ...
        <asp:Panel ID="pnlAreaUsuario" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackImageUrl="~/imagenes/fondo.jpg">
            <table style="width:100%">
                ...
                <tr>
                    <td style="text-align: center">
                        <asp:ImageButton ID="btnAbmUsuarios" ImageUrl="~/imagenes/abmUsuarios.png" runat="server" Width="263px" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
        ...
        <%--Panel ABM Usuarios --%>
<asp:Panel ID="pnlAbmUsuarios" runat="server" BorderColor="#66CCFF" ForeColor="#372c57" Font-Size="Large" Visible="false" BackColor="#94bbd4">
            <%--Tabla Botones --%>
            <table style="width: 100%">
                <tr style="text-align: center">
                    <td colspan="2">
